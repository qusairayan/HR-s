                        ...
                        <td>
                            <div class="form-check dashboard-check">
                                <input class="form-check-input" type="checkbox" value=""
                                    id="leaveCheck{{ $leave->id }}">
                                <label class="form-check-label" for="leaveCheck{{ $leave->id }}">
                                </label>
                            </div>
                        </td>
