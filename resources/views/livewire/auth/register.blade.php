                            ...
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <!-- End of Form -->
                                 ...
                                 <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3"><svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg></span>
                                        <input wire:model="username" id="username" type="text" class="form-control" placeholder="" autofocus required>
                                    </div>
                                ...
                                <!-- End of Form -->
                                 ...
                                 <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3"><svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg></span>
                                        <input wire:model="company" id="company" type="number" class="form-control" placeholder="" autofocus required>
                                    </div>
                                ...
                                <!-- End of Form -->
                                 ...
                                 <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3"><svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg></span>
                                        <input wire:model="department" id="department" type="department" class="form-control" placeholder="example@company.com" autofocus required>
                                    </div>
