...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('employees.addNew')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                ...
                <tr>
                    ...
                    <td class="border-0 fw-bold">
                        <span class="fw-normal">
                            ...
                            {!! $user->status == 1 ? '<span class="fw-bold text-success">Active</span>' : '<span class="fw-bold text-danger">Inactive</span>' !!}
                        </span>
                </td>
                    ...
                    <td class="border-0 fw-bold">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <a class="dropdown-item" href="{{ route('employees.edit', ['user' => $user->id]) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                                <a class="dropdown-item text-danger rounded-bottom" href="{{ route('employees.remove', ['user' => $user->id]) }}"><span
