<div>
    <title>Edit Roles Permissions </title>
        ...
        <div class="col-5 px-0">
            <div class="card border-0 shadow ">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="rolePermissionSearch"
                        wire:model="rolePermissionSearch" placeholder="Search" aria-label="Search"
                        fdprocessedid="x0f6n">
                </div>
                <div class="card-body py-4  fmxh-18rem">


                    @foreach ($this->roleAllPermissions as $permission)
                        <div class="row align-items-center mb-4">
