                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check dashboard-check">
                            <input class="form-check-input" type="checkbox" value="" id="userCheck{{$salary->id}}">
                            <label class="form-check-label" for="userCheck{{$salary->id}}">
                            </label>
                        </div>
                    </td>
                    ...
                    <td>
                        <a href="#" class="d-flex align-items-center">
                            <img src="/storage/profile/{{ $salary->image }}" class="avatar rounded-circle me-3" alt="Avatar">
                            <div class="d-block">
                    ...
                    <div class="d-block">
                        <div class="small text-gray">{{$salary->position}}</div>
                    </div>
                </td>
                    ...
                    <td class="border-0 fw-bold">
                        <span class="fw-normal">
                            ...
                            {!! $salary->status == 1 ? '<span class="fw-bold text-success">Active</span>' : '<span class="fw-bold text-danger">Inactive</span>' !!}
                        </span>
                </td>
                    ...
                    <td class="border-0 fw-bold">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <a class="dropdown-item" wire:click="editSalary(1)">
                                    <span class="fas fa-edit me-2"></span>Edit
                                </a>
                                <a class="dropdown-item text-danger rounded-bottom" wire:click="removeSalary(1)">
