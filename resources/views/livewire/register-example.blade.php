                        ...
                        <form action="#" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" placeholder="example@company.com"
                                        id="birth">
                                </div>
                            </div>
                            <!-- End of Form -->
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="phone" class="form-control" placeholder="example@company.com"
                                        id="phone">
                                </div>
                            </div>
                            <!-- End of Form -->
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="example@company.com"
                                        id="address">
                                </div>
                            </div>
                            <!-- End of Form -->
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select placeholder="Select department" class="form-control" id="department"
                                        aria-describedby="basic-addon2">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select placeholder="Select company" class="form-control" id="company"
                                        aria-describedby="basic-addon2">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input placeholder="Select start date" class="form-control" id="start_date" type="date"
                                        aria-describedby="basic-addon2">
